...
describe('Workspace', () => {
  ...
  it('updates a section', () => {
    ...
    workspace.updateSection('home', 'test-1', { text: 'Updated' });
    const sections = workspace.getSections('home');
  ...
  it('removes a section', () => {
    ...
    workspace.removeSection('home', 'test-1');
    expect(workspace.getSections('home')).toHaveLength(0);
  });
  ...
  it('persists across workspace instances', () => {
    ...
    expect(workspace2.getSections('home')).toHaveLength(1);
  });
});
